...
class Ticker extends Colors {
	...
	public function __construct()
	{
		...
		while(true)
		{
			$this->get_data(array('GOOG','AAPL','MSFT'),$colors);
		}
	}			
	...
	{		
		...
		foreach ($symbols as $symbol) 
		{
			...
			$return .= "$symbol ";
			$return .= "$lasttrade ";
			if ($change<0) $return .= $colors->getColoredString($change, "red", "black");
			else $return .= $colors->getColoredString($change, null, "cyan");
